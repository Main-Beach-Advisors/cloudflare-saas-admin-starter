...
3. Create a [D1 database](https://developers.cloudflare.com/d1/get-started/) with the name "cloudflare-saas-admin-starter":

```bash
npx wrangler d1 create cloudflare-saas-admin-starter
```
